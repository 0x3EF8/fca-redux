        ...
        (async function resolveAttachmentUrl(i) {
            if (v.delta.attachments && i == v.delta.attachments.length) {
                ...
                if (fmtMsg) {
                    ...
                    // Auto-store message for anti-unsend (excluded in this refactor per instructions)
                ...
                if (v.delta.attachments && v.delta.attachments[i].mercury.attach_type == "photo") {
                    api.resolvePhotoUrl(v.delta.attachments[i].fbid, (err: any, url: any) => {
            ...
            for (const i in clientPayload.deltas) {
                ...
                if (delta.deltaMessageReaction && !!ctx.globalOptions.listenEvents) {
                    ...
                    const callbackToReturn: any = {
                        ...
                        attachments: delta.deltaMessageReply.message.attachments.map((att: any) => {
                            try {
                    ...
                    // Auto-store reply message (excluded)
